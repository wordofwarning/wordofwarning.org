...
#### Access Information        
Age Advisory: ***14 or 16***+ (parental/guardian discretion).<br>Warnings: to be confirmed by early April; for specific content warnings please click [here](/warnings).<br>Duration: including an interval, the ***double/triple bill*** will end by ***9.30/10pm*** each night.<br>Features: live spoken English, with more content to be confirmed.<br>Specific age + access info: please get in touch with us by emailing <mailto:info@habmcr.org> or call 0161 232 6086 during weekday office hours.                  
