...
Our annual sampler of new performance is a ***double/triple*** bill of new works in development from artists at the start of their journeys… To get a feel for it, have a look at [2019](/archive/2019-worksahead).            
...
Enquiries: 07488 308 111 (*on the night*)           
        
#### Access Information        
Age Advisory: ***16***+ (parental/guardian discretion).<br>Warnings: to be confirmed by early April; for specific content warnings please click [here](/warnings).<br>Duration: including an interval, the ***double/triple*** bill will end by ***9.30/10pm*** each night.<br>Features: live spoken English, with more content to be confirmed.<br>Specific age + access info: please get in touch with us by emailing <mailto:info@habmcr.org> or call 0161 232 6086 during weekday office hours.                  
