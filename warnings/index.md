...
Age Advisory: suitable for all ages (parental/guardian/carer discretion).<br>**Allergy Warnings: latex (balloons), banana, milk (whipped cream).**<br>Content Warnings: use of lasers; some works may disturb; some works involve audience interaction or participation; specific warnings follow:<br>Gemma Lees — use of neon lights; possible audience interaction with flashing lights.<br>Joe Beedles — use of lasers.<br>Kitunda Argyle — (**Allergy Warning: milk**) whipped cream is used by the artists; potential for audience interaction.<br>Krissi Musiol & Amy Vreeke — (**Allergy Warning: latex**) loud and/or sudden bangs & noises, e.g. popping balloons.<br>Plaster Cast — (**Allergy Warning: banana**) bananas are used by the artists; potential for audience interaction.
