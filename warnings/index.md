...
Age Advisory: suitable for all ages (parental/guardian/carer discretion).<br>**Allergy Warnings: latex (balloons), banana, milk (whipped cream).**<br>Content Warnings: use of lasers; some works may disturb; some works involve audience interaction or participation; specific warnings follow:<br>&nbsp;Gemma Lees — use of neon lights; possible audience interaction with flashing lights.<br>&nbsp;Joe Beedles — use of lasers.<br>&nbsp;Kitunda Argyle — whipped cream (**Allergy Warning: milk**) is used by the artists with potential for audience interaction.<br>&nbsp;Krissi Musiol & Amy Vreeke — loud and/or sudden bangs & noises, e.g. popping balloons (**Allergy Warning: latex**).<br>&nbsp;Plaster Cast — bananas (**Allergy Warning: banana**) are used by the artists with potential for audience interaction.
