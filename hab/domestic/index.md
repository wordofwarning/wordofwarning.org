...
We're interested in what artists want to say right now — our <a href="http://domesticmcr.posthaven.com" target="_blank">open call</a> seeks proposals for short (max 10 min) live art + contemporary performance works that can be presented online within your available resources — next event is **7 October**<sup>†</sup>.
          
Watch live streams on YouTube of <a href="http://youtu.be/IUNv7CARKLU" target="_blank">**July's pilot event**</a>, featuring six invited artists, and <a href="http://youtu.be/AOT29ZTtZAA" target="_blank">**August's second event**</a>, with seven works selected from our open call.        
        
<sup>†</sup> In the interests of full disclosure, we're aware that appetite for making work online is on the wane — so we're using this call out as a litmus test. We believe that this is only worth doing if we can do it well — so if the right work isn't there to make up a really good programme for 7 October, we might all be better served by not doing it!<br>Equally, this call out will remain open on a rolling basis for potential future events.        
...
<small>*Updated 3 August, 6.30pm*</small>
